...
///
/// on 2022/7/24.
class WTitleBar extends StatelessWidget {
  final String? title;
  ...
  WTitleBar(this.title, {super.key, this.iconData, this.onRightIconPressed, this.needRightLocalIcon = false, this.rightWidget});
    ...
    if (rightWidget == null) {
      widget = (needRightLocalIcon)
          ? IconButton(
              ...
              onPressed: () {
                RenderBox renderBox2 = rightKey.currentContext?.findRenderObject() as RenderBox;
