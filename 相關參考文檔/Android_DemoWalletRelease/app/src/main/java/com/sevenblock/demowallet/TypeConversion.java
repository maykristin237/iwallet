...
public class TypeConversion {
     ...
     * @exclude
     */
//    public static TxSignResult convert(org.consenlabs.tokencore.wallet.transaction.TxSignResult from) {
//        return new TxSignResult(from.getSignedTx(), from.getTxHash(), from.getWtxID());
//    }
}
